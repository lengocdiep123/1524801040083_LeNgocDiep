...
{
    public class HSSVTinController : SqlDataProvider
    {
        #region[HSSVTintuc_Insert]
        public void HSSVTintuc_Insert(HSSVTinInfo data)
        {
            using (SqlCommand cmd = new SqlCommand("sp_HSSVTintuc_Insert", GetConnection()))
            {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("sp_HSSVTintuc_Update", GetConnection()))
            {
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            using (SqlCommand cmd = new SqlCommand("sp_HSSVTintuc_UpdateDangtin", GetConnection()))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@ID", data.ID));
                cmd.Parameters.Add(new SqlParameter("@dangtin", data.dangtin));
        ...
        {
            using (SqlCommand cmd = new SqlCommand("sp_HSSVTintuc_Delete", GetConnection()))
            {
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            using (SqlCommand cmd = new SqlCommand("sp_HSSVTintuc_GetByAll", GetConnection()))
            {
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            using (SqlCommand cmd = new SqlCommand("sp_HSSVTintuc_GetByChude", GetConnection()))
            {
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            using (SqlCommand cmd = new SqlCommand("sp_HSSVTintuc_GetByTop", GetConnection()))
            {
                cmd.CommandType = CommandType.StoredProcedure;

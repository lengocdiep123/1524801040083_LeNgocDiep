...
{
    public partial class TSXemchitiettin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (String.Compare(tach[0], "ID", true) == 0)
                {
                    ...
                    dt = TSTinServiecs.db.TSTintuc_GetByTop("", "ID=" + Request.QueryString["ID"].ToString(), "");
                    DataTable dttieude = TSServiecs.db.TS_GetByTop("", "ID=" + dt.Rows[0]["IDChude"].ToString(), "");
        ...
        {
             Response.Redirect("~/web.Tuyensinh/Tuyensinh.aspx");
        }

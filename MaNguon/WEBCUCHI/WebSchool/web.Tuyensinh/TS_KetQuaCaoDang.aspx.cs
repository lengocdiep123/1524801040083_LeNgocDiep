...
{
    public partial class TS_KetQuaCaoDang : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TSKetQuaServiecs.db.TSKetQua_GetByTop("", "ID=1", "");
                ...
                DataTable dt = TSKetQuaTinServiecs.db.TSKetQuaTintuc_GetByTop("", "IDChude=1 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

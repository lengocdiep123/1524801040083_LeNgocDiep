...
{
    public partial class TS_GioiThieuViecLam : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TSServiecs.db.TS_GetByTop("", "ID=8", "");
                ...
                DataTable dt = TSTinServiecs.db.TSTintuc_GetByTop("", "IDChude=8 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {
        ...
        protected void lbtback_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = TSTinServiecs.db.TSTintuc_GetByTop("", "IDChude=7 and dangtin=1", "ID desc");
        ...
        DataTable BindGirdListFile(string IDTin)
        {
            ...
            dt = TSFileServices.db.TSFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                string ID = e.CommandArgument.ToString();
                DataTable dt = TSFileServices.db.TSFile_GetByTop("", "ID=" + ID, "");

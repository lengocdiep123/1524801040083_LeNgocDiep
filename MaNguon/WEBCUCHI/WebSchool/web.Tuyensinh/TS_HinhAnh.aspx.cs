...
{
    public partial class TS_HinhAnh : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TSServiecs.db.TS_GetByTop("", "ID=9", "");
                ...
                DataTable dt = TSTinServiecs.db.TSTintuc_GetByTop("", "IDChude=9 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {
        ...
        protected void lbtback_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = TSTinServiecs.db.TSTintuc_GetByTop("", "IDChude=1 and dangtin=1", "ID desc");

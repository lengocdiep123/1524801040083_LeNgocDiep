...
{
    public partial class DaoTao_CTDT_TCN : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = DaoTaoCTDTTinServiecs.db.DaoTaoCTDTTintuc_GetByTop("", "IDChude=2 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

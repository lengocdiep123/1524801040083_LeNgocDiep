...
{
    public partial class DaoTao_CTDTNganHan : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = DaoTaoCTDTServiecs.db.DaoTaoCTDT_GetByTop("", "ID=3", "");
                ...
                DataTable dt = DaoTaoCTDTTinServiecs.db.DaoTaoCTDTTintuc_GetByTop("", "IDChude=3 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

...
{
    public partial class HSSV_Thongtin : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = HSSVServiecs.db.HSSV_GetByTop("", "ID=2", "");
                ...
                DataTable dt = HSSVTinServiecs.db.HSSVTintuc_GetByTop("", "IDChude=2 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

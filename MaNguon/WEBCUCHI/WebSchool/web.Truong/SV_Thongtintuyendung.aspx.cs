...
{
    public partial class SV_Thongtintuyendung : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongSinhVienServiecs.db.TruongSinhVien_GetByTop("", "ID=6", "");
                ...
                DataTable dt = TruongSinhVienTinServiecs.db.TruongSinhVienTintuc_GetByTop("", "IDChude=6 and dangtin=1", "ID desc");

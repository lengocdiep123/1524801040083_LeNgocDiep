...
{
    public partial class SV_Xemchitiettin : System.Web.UI.Page
    {
        HtmlHead headTag;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (String.Compare(tach[0], "tkb", true) == 0)
                {
                    DataTable dttieude = TruongSinhVienServiecs.db.TruongSinhVien_GetByTop("", "ID=2", "");
                    ...
                    dt = TruongSinhVienTinServiecs.db.TruongSinhVienTintuc_GetByTop("", "IDChude=2 and ID=" + Request.QueryString["tkb"].ToString(), "");
        ...
        {
            DataTable dt = new DataTable();
            dt = TruongSinhVienFileServices.db.TruongSinhVienFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = TruongSinhVienFileServices.db.TruongSinhVienFile_GetByTop("", "ID=" + ID, "");

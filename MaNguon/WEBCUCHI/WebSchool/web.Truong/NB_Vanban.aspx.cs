...
{
    public partial class NB_Vanban : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongNoiBoServiecs.db.TruongNoiBo_GetByTop("", "ID=2", "");
                ...
                DataTable dt = TruongNoiBoTinServiecs.db.TruongNoiBoTintuc_GetByTop("", "IDChude=2 and dangtin=1", "ID desc");

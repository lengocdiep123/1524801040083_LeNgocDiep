...
{
    public partial class NB_Congthongtintruong : System.Web.UI.Page
    {
        HtmlHead headTag;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = TruongNoiBoTinServiecs.db.TruongNoiBoTintuc_GetByTop("", "IDChude=4 and dangtin=1", "ID desc");

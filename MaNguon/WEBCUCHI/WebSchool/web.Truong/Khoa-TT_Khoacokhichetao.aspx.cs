...
{
    public partial class Khoa_TT_Khoacokhichetao : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongKhoaTrungTamServiecs.db.TruongKhoaTrungTam_GetByTop("", "ID=1", "");
                ...
                DataTable dt = TruongKhoaTrungTamTinServiecs.db.TruongKhoaTrungTamTintuc_GetByTop("", "IDChude=1 and dangtin=1", "ID desc");

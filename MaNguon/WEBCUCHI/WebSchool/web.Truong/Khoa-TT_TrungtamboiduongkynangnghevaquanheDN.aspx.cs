...
{
    public partial class Khoa_TT_TrungtamboiduongkynangnghevaquanheDN : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongKhoaTrungTamServiecs.db.TruongKhoaTrungTam_GetByTop("", "ID=11", "");
                ...
                DataTable dt = TruongKhoaTrungTamTinServiecs.db.TruongKhoaTrungTamTintuc_GetByTop("", "IDChude=11 and dangtin=1", "ID desc");

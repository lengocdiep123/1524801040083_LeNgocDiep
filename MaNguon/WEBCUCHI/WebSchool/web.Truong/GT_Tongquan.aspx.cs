...
{
    public partial class GT_Tongquan : System.Web.UI.Page
    {
        HtmlHead headTag;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
				DataTable dttieude = TruongGioiThieuServiecs.db.TruongGioiThieu_GetByTop("", "ID=1", "");
                ...
                DataTable dt = TruongGioiThieuTinServiecs.db.TruongGioiThieuTintuc_GetByTop("1", "IDChude=1 and dangtin=1", "ID desc");

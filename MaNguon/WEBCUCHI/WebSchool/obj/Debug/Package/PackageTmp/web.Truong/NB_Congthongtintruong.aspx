        ...
        <div class="art-postcontent art-postcontent-0 clearfix">
            <asp:Panel ID="pnlist" runat="server">
                <asp:DataList ID="dtlnews" runat="server" Width="100%" GridLines="Vertical">
                    <ItemTemplate>
                        <p  style="padding:1px 4px 1px 12px"><asp:HyperLink ID="hlnewsdetail" runat="server" NavigateUrl='<%# String.Concat("NB_Congthongtin.aspx?truong=", Eval("ID")) %>' Text='<%# Eval("tieude") %>' ForeColor="#0066FF" Font-Size="X-Large"></asp:HyperLink></p>

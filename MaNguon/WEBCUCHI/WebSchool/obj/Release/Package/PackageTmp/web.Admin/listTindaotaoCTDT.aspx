<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTindaotaoCTDT.aspx.cs" Inherits="WebSchool.web.Admin.listTindaotaoCTDT" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTindaotao.aspx" class="active">Đăng tin phòng đào tạo</a>
                              <ul class="active">
                                 <li><a href="listTindaotao.aspx">Đăng tin phòng đào tạo</a>

                                 </li>
                                 <li><a href="listTindaotaoCTDT.aspx">Đăng tin chương tình đào tạo</a>
            ...
            <div class="art-layout-cell art-content"><article class="art-post art-article">
                <asp:Panel ID="pnList" runat="server">
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix"><p><br/></p>
                        ...
                        <br />
                        <p><a><span style="font-weight: bold; font-size: 14px; color: #7D2B03;">Chủ đề:&nbsp;&nbsp;</span><asp:DropDownList ID="ddlChude" runat="server" DataSourceID="SqlDaotaoCTDTChude" DataTextField="Chude" DataValueField="ID" OnSelectedIndexChanged="ddlChude_SelectedIndexChanged" AutoPostBack="True" CssClass="art-button" Width="280px"></asp:DropDownList>
                            <asp:SqlDataSource runat="server" ID="SqlDaotaoCTDTChude" ConnectionString='<%$ ConnectionStrings:websiteschoolConnectionString %>' SelectCommand="SELECT * FROM [DaotaoCTDT]">
                            </asp:SqlDataSource>
                                ...
                                <div class="art-content-layout-row">
                                     <div class="art-layout-cell" style="width: 100%" >
                                        <table class="art-article" style="width: 100%; ">
                                            <tbody>
                                                <tr><td style="width: 14%; ">Nơi đăng tin:&nbsp;<br/></td><td style="width: 50%; " ><asp:DropDownList ID="ddlChudenew" runat="server" Font-Size="Medium" Height="34px" Width="99%" CssClass="art-button" DataSourceID="SqlDaotaoCTDTChude" DataTextField="Chude" DataValueField="ID"></asp:DropDownList>
                                                  
                                                     </td>
                                                </tr>
                                               <%-- <tr>
                                                    <td style="width: 14%; ">Nơi đăng tin:&nbsp;<br/></td><td style="width: 50%; " >
                                                        <asp:DropDownList ID="ddlLoaiCT" runat="server" Font-Size="Medium" Height="34px" Width="99%" CssClass="art-button">
                                                            <asp:ListItem Value="0">Chọn loại chương trình</asp:ListItem>    
                                                            <asp:ListItem Value="1">Chương trình khung</asp:ListItem>
                                                            <asp:ListItem Value="2">Chương trình chi tiết</asp:ListItem>
                                                        </asp:DropDownList>

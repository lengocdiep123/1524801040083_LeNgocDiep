<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="Thuvien.aspx.cs" Inherits="WebSchool.web.Truong.Thuvien" %>

<%@ Register Assembly="CollectionPager" Namespace="SiteUtils" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <%--Thư viện-Trường Trung Cấp Nghề Củ Chi--%>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTincongtacsinhvien.aspx.cs" Inherits="WebSchool.web.Admin.listTincongtacsinhvien" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTincongtacsinhvien.aspx" class="active">Đăng tin phòng công tác HSSV & quan hệ xí nghiệp</a>
                              <ul class="active">
                                 <li><a href="listTincongtacsinhvien.aspx">Đăng tin phòng công tác HSSV & quan hệ xí nghiệp</a>

                                 </li>
                                 <li><a href="listTinSinhvien.aspx">Đăng tin sinh viên</a>
            ...
            <div class="art-layout-cell art-content"><article class="art-post art-article">
                <asp:Panel ID="pnList" runat="server">
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix"><p><br/></p>
                        ...
                        <br />
                        <p><a><span style="font-weight: bold; font-size: 14px; color: #7D2B03;">Chủ đề:&nbsp;&nbsp;</span><asp:DropDownList ID="ddlChude" runat="server" DataSourceID="SqlHSSVGTChude" DataTextField="Chude" DataValueField="ID" OnSelectedIndexChanged="ddlChude_SelectedIndexChanged" AutoPostBack="True" CssClass="art-button" Width="280px" ></asp:DropDownList>
                            <asp:SqlDataSource runat="server" ID="SqlHSSVGTChude" ConnectionString='<%$ ConnectionStrings:websiteschoolConnectionString %>' SelectCommand="SELECT * FROM [HSSV]">
                            </asp:SqlDataSource>
                                ...
                                <div class="art-content-layout-row">
                                     <div class="art-layout-cell" style="width: 100%" >
                                        <table class="art-article" style="width: 100%; ">
                                            <tbody>
                                                <tr><td style="width: 14%; ">Nơi đăng tin:&nbsp;<br/></td><td style="width: 50%; " ><asp:DropDownList ID="ddlChudenew" runat="server" Font-Size="Medium" Height="34px" Width="99%" CssClass="art-button" DataSourceID="SqlHSSVGTChude" DataTextField="Chude" DataValueField="ID"></asp:DropDownList>

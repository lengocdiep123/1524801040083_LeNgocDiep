<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinhoptacquoctevakhoahoc.aspx.cs" Inherits="WebSchool.web.Admin.listTinhoptacquoctevakhoahoc" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTintaichinh.aspx" class="active">Đăng tin hợp tác quốc tế và quản lý khoa học</a>
                             <ul class="active">

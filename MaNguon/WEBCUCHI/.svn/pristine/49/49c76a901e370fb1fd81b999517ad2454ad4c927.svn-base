<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinhoisinhvien.aspx.cs" Inherits="WebSchool.web.Admin.listTinhoisinhvien" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTinhoisinhvien.aspx" class="active">Đăng tin hội sinh viên</a>
                             <ul class="active">

...
{
    public partial class DaoTao_KeHoach : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = DaoTaoServiecs.db.DaoTao_GetByTop("", "ID=3", "");
                ...
                DataTable dt = DaoTaoTinServiecs.db.DaoTaoTintuc_GetByTop("", "IDChude=3 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

...
{
    public partial class listTinnoibotruong : System.Web.UI.Page
    {
        ...
        {
            grdList.DataSource = TruongNoiBoTinServiecs.db.TruongNoiBoTintuc_GetByChude(idchude);
            grdList.DataBind();
        }
        ...
        {
            //lbtempID.Text = ddlChude.SelectedValue;
        ...
        protected void bt_savenews_Click(object sender, EventArgs e)
        {
            if (bt_savenews.Text == "Thêm tin")
            {
                try
                {
                    ...
                    obj.dangtin = (0).ToString();
                    TruongNoiBoTinServiecs.db.TruongNoiBoTintuc_Insert(obj);
                    pnList.Visible = true;
                    pnCreate.Visible = false;
                    DataTable dt = TruongNoiBoTinServiecs.db.TruongNoiBoTintuc_GetByTop("1", "", "ID DESC");
                    lbTieudethemfile.Text = dt.Rows[0]["tieude"].ToString();
            ...
            else
            {
                ...
                obj.ngaysua = DateTime.Now;
                obj.dangtin = (0).ToString();
                TruongNoiBoTinServiecs.db.TruongNoiBoTintuc_Update(obj);
                pnList.Visible = true;
                pnCreate.Visible = false;
        ...
        protected void bt_savefile_Click(object sender, EventArgs e)
        {
            try
            {
                TruongNoiBoFileInfo obj = new TruongNoiBoFileInfo();
                ...
                if (upfile1.HasFile)
                {
                    if (CheckFileTypeDocuments(upfile1.FileName))
                    {
                        ...
                        TruongNoiBoFileServices.db.TruongNoiBoFile_Insert(obj);
                        pnlistfile.Visible = true;
                        pnattachfile.Visible = false;
        ...
        {
            grdattachfiles.DataSource = TruongNoiBoFileServices.db.TruongNoiBoFile_GetByTop("", "IDTin=" + IDTin, "");
        ...
        protected void grdattachfiles_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dtFile = TruongNoiBoFileServices.db.TruongNoiBoFile_GetByTop("", "ID=" + temp, "");
                    if (dtFile != null)
                    {
                        string pathFile = dtFile.Rows[0]["Duongdan"].ToString();
                        TruongNoiBoFileServices.db.TruongNoiBoFile_Delete(temp);

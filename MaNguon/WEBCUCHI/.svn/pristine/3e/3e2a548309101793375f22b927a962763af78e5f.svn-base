<%@ Page Title="" Language="C#" MasterPageFile="~/web.Tuyensinh/web.tuyensinh.Master" AutoEventWireup="true" CodeBehind="TSXemchitiettin.aspx.cs" Inherits="WebSchool.web.Tuyensinh.TSXemchitiettin" %>

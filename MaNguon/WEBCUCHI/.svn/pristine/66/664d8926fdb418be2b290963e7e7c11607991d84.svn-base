...
{
    public partial class PB_Phongtaichinh : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
				DataTable dttieude = TruongPhongBanServiecs.db.TruongPhongBan_GetByTop("", "ID=2", "");
                ...
                DataTable dt = TruongPhongBanTinServiecs.db.TruongPhongBanTintuc_GetByTop("", "IDChude=2 and dangtin=1", "ID desc");

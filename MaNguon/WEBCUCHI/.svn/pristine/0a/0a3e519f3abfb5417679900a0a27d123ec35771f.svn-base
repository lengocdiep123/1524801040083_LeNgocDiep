...
{
    public partial class DT_Doanthanhnien1 : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongDoanTheServiecs.db.TruongDoanThe_GetByTop("", "ID=4", "");
                ...
                DataTable dt = TruongDoanTheTinServiecs.db.TruongDoanTheTintuc_GetByTop("", "IDChude=4 and dangtin=1", "ID desc");
        ...
        DataTable BindGirdListFile(string IDTin)
        {
            ...
            dt = TruongDoanTheFileServices.db.TruongDoanTheFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                string ID = e.CommandArgument.ToString();
                DataTable dt = TruongDoanTheFileServices.db.TruongDoanTheFile_GetByTop("", "ID=" + ID, "");

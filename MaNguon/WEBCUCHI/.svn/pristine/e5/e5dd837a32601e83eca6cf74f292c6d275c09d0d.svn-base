...
{
    public partial class TS_Huongnghiep : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TSServiecs.db.TS_GetByTop("", "ID=7", "");
        ...
        protected void lbtback_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = TSTinServiecs.db.TSTintuc_GetByTop("", "IDChude=6 and dangtin=1", "ID desc");

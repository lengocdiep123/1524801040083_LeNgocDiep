...
{
    public partial class changeHeader : System.Web.UI.Page
    {
        ...
        protected void bt_savefile_Click(object sender, EventArgs e)
        {
            ...
            if (upfile1.HasFile)
            {
                ...
                {
                    strFileName01 = string.Format("{0}\\{1}{2}", Server.MapPath(@"web.Truong/images"), "header", upfile1.FileName.Substring(upfile1.FileName.LastIndexOf(".")));

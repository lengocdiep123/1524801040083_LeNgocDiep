...
{
    public partial class TS_HoSoTS : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               lbchudetieude.Text = "Hồ sơ tuyển sinh";
               headTag.Title = "Hồ sơ tuyển sinh - Trường Trung Cấp Nghề Củ Chi";
              

                DataTable dt = TSHoSoTinServiecs.db.TSHoSoTintuc_GetByTop("", "dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="PB_PhonghoptacQTvaKH.aspx.cs" Inherits="WebSchool.web.Truong.PB_PhonghoptacQTvaKH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="art-postmetadataheader">
            <h2 class="art-postheader">PHÒNG HỢP TÁC QUỐC TẾ VÀ QUẢN LÝ KHOA HỌC</h2>

...
{
    public partial class GT_Thanhtichdatduoc : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongGioiThieuServiecs.db.TruongGioiThieu_GetByTop("", "ID=5", "");
                ...
                DataTable dt = TruongGioiThieuTinServiecs.db.TruongGioiThieuTintuc_GetByTop("", "IDChude=5 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {
        ...
        protected void lbtnews_Command(object sender, CommandEventArgs e)
        {
            ...
            DataTable dt = TruongGioiThieuTinServiecs.db.TruongGioiThieuTintuc_GetByTop("", "ID=" + ID, "");
        ...
        DataTable BindGirdListFile(string IDTin)
        {
            ...
            dt = TruongGioiThieuFileServices.db.TruongGioiThieuFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                string ID = e.CommandArgument.ToString();
                DataTable dt = TruongGioiThieuFileServices.db.TruongGioiThieuFile_GetByTop("", "ID=" + ID, "");

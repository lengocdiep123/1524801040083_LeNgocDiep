...
namespace WebSchool.web.Truong
{
    public partial class Thuvien : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongThuVienServiecs.db.TruongThuVien_GetByTop("", "ID=1", "");
                ...
                DataTable dt = TruongThuVienTinServiecs.db.TruongThuVienTintuc_GetByTop("", "IDChude=1 and dangtin=1", "ID desc");
        ...
        DataTable BindGirdListFile(string IDTin)
        {
            ...
            dt = TruongThuVienFileServices.db.TruongThuVienFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                string ID = e.CommandArgument.ToString();
                DataTable dt = TruongThuVienFileServices.db.TruongThuVienFile_GetByTop("", "ID=" + ID, "");

...
{
    public partial class TS_HoSoCaoDang : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TSHoSoServiecs.db.TSHoSo_GetByTop("", "ID=1", "");
                ...
                DataTable dt = TSHoSoTinServiecs.db.TSHoSoTintuc_GetByTop("", "IDChude=1 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

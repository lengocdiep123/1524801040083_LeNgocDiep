<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="GT_Bangiamhieu.aspx.cs" Inherits="WebSchool.web.Truong.GT_Bangiamhieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="art-postmetadataheader">
            <h2 class="art-postheader">BAN GIÁM HIỆU</h2>

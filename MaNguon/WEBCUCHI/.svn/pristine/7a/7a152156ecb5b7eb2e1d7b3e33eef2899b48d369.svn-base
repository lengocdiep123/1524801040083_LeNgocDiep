...
{
    public partial class DaoTao_BieuMau : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = DaoTaoServiecs.db.DaoTao_GetByTop("", "ID=5", "");
                ...
                DataTable dt = DaoTaoTinServiecs.db.DaoTaoTintuc_GetByTop("", "IDChude=5 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {
        ...
        protected void lbtback_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = DaoTaoTinServiecs.db.DaoTaoTintuc_GetByTop("", "IDChude=5 and dangtin=1", "");

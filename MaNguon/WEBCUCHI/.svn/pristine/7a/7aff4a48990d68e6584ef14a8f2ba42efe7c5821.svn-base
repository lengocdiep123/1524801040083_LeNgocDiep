<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="SV_Hinhanh.aspx.cs" Inherits="WebSchool.web.Truong.SV_Hinhanh" %>

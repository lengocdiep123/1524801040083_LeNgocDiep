<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinkhoakinhte.aspx.cs" Inherits="WebSchool.web.Admin.listTinkhoakinhte" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTinkhoakinhte.aspx" class="active">Đăng tin khoa kinh tế</a>
                             <ul class="active">

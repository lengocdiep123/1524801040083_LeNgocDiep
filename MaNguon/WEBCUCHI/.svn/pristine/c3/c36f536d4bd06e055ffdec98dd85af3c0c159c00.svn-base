<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinkhoacongnghethucpham.aspx.cs" Inherits="WebSchool.web.Admin.listTinkhoacongnghethucpham" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTinkhoacongnghethucpham.aspx" class="active">Đăng tin khoa công nghệ thực phẩm</a>
                             <ul class="active">

...
{
    public partial class HSSVXemchitiettin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (String.Compare(tach[0], "ID", true) == 0)
                {
                    ...
                    dt = HSSVTinServiecs.db.HSSVTintuc_GetByTop("", "ID=" + Request.QueryString["ID"].ToString(), "");
                    DataTable dttieude = HSSVServiecs.db.HSSV_GetByTop("", "ID="+dt.Rows[0]["IDChude"].ToString(), "");
        ...
        {
              Response.Redirect("~/web.PhongCongtacHSSV/PhongcongtacHSSV.aspx");
        }

        DataTable BindGirdListFile(string IDTin)
        {
            DataTable dt = new DataTable();
            dt = HSSVFileServices.db.HSSVFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = HSSVFileServices.db.HSSVFile_GetByTop("", "ID=" + ID, "");

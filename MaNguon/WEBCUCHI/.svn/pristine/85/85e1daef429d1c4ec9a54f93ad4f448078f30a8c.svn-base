...
{
    public partial class Khoa_TT_Khoadiendienlanh : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongKhoaTrungTamServiecs.db.TruongKhoaTrungTam_GetByTop("", "ID=4", "");
                ...
                DataTable dt = TruongKhoaTrungTamTinServiecs.db.TruongKhoaTrungTamTintuc_GetByTop("", "IDChude=4 and dangtin=1", "ID desc");

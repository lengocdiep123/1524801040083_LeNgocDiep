<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="GT_Tongquan.aspx.cs" Inherits="WebSchool.web.Truong.GT_Tongquan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <article class="art-post art-article">
        <div class="art-postmetadataheader">
            <h2 class="art-postheader">TỔNG QUAN</h2>

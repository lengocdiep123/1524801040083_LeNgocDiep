<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTintttuyensinhvahotrovieclam.aspx.cs" Inherits="WebSchool.web.Admin.listTintttuyensinhvahotrovieclam" %>
            ...
            <div class="art-layout-cell art-content"><article class="art-post art-article">
                <asp:Panel ID="pnList" runat="server">
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix"><p><br/></p>
                        ...
                        <br />
                        <p><a><span style="font-weight: bold; font-size: 14px; color: #7D2B03;">Chủ đề:&nbsp;&nbsp;</span><asp:DropDownList ID="ddlChude" runat="server" DataSourceID="SqlTSGTChude" DataTextField="Chude" DataValueField="ID" OnSelectedIndexChanged="ddlChude_SelectedIndexChanged" AutoPostBack="True" CssClass="art-button" Width="280px"></asp:DropDownList>
                            <asp:SqlDataSource runat="server" ID="SqlTSGTChude" ConnectionString='<%$ ConnectionStrings:websiteschoolConnectionString %>' SelectCommand="SELECT * FROM [TS]">
                            </asp:SqlDataSource>
                                ...
                                <div class="art-content-layout-row">
                                     <div class="art-layout-cell" style="width: 100%" >
                                        <table class="art-article" style="width: 100%; ">
                                            <tbody>
                                                <tr><td style="width: 14%; ">Nơi đăng tin:&nbsp;<br/></td><td style="width: 50%; " ><asp:DropDownList ID="ddlChudenew" runat="server" Font-Size="Medium" Height="34px" Width="99%" CssClass="art-button" DataSourceID="SqlTSGTChude" DataTextField="Chude" DataValueField="ID"></asp:DropDownList>

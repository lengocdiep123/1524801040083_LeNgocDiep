<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="NB_Vanban.aspx.cs" Inherits="WebSchool.web.Truong.NB_Vanban" %>

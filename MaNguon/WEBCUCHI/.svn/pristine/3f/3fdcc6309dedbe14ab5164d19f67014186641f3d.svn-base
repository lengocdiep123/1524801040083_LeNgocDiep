<%@ Page Title="" Language="C#" MasterPageFile="~/web.Tuyensinh/web.tuyensinh.Master" AutoEventWireup="true" CodeBehind="TS_HinhAnh.aspx.cs" Inherits="WebSchool.web.Tuyensinh.TS_HinhAnh" %>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style=" border: none; text-align:center">
                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("anhdaidien")%>' Visible='<%#checkVisible(Eval("anhdaidien").ToString())%>' Width="70%" CssClass="art-lightbox" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style=" padding-left: 0.3cm; padding-right: 0.3cm; border: none; text-align: justify">
                                        <asp:Label ID="lbnoidung" runat="server" Text='<%# Eval("noidung") %>' Font-Size="Large" CssClass="art-lightbox"></asp:Label>
                                    </td>
                                </tr>
                                <tr>

...
{
    public partial class DaoTao_CTDTLienThong : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = DaoTaoCTDTServiecs.db.DaoTaoCTDT_GetByTop("", "ID=4", "");
                ...
                DataTable dt = DaoTaoCTDTTinServiecs.db.DaoTaoCTDTTintuc_GetByTop("", "IDChude=4 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

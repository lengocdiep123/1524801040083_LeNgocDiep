<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinhoicuusinhvien.aspx.cs" Inherits="WebSchool.web.Admin.listTinhoicuusinhvien" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTinhoicuusinhvien.aspx" class="active">Đăng tin hội cựu sinh viên</a>
                             <ul class="active">

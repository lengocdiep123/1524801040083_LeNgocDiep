<%@ Page Title="" Language="C#" MasterPageFile="~/web.PhongDaotao/web.Phongdaotao.Master" AutoEventWireup="true" CodeBehind="DaoTao_KeHoach.aspx.cs" Inherits="WebSchool.web.PhongDaotao.DaoTao_KeHoach" %>

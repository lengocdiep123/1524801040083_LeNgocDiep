<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="PB_Phongquantrithietbi.aspx.cs" Inherits="WebSchool.web.Truong.PB_Phongquantrithietbi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="art-postmetadataheader">
            <h2 class="art-postheader">PHÒNG QUẢN TRỊ THIẾT BỊ</h2>

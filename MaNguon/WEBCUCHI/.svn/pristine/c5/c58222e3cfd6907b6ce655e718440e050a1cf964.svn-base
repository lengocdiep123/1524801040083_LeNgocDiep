<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTindambaochatluongvakhaothi.aspx.cs" Inherits="WebSchool.web.Admin.listTindambaochatluongvakhaothi" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTinhanhchinh.aspx" class="active">Đăng tin đảm bảo chất lượng và khảo thí</a>
                             <ul class="active">

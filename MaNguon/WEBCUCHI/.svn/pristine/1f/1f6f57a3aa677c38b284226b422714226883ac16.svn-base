...
{
    public partial class TS_KetQuaTrungcap : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TSKetQuaServiecs.db.TSKetQua_GetByTop("", "ID=2", "");
                ...
                DataTable dt = TSKetQuaTinServiecs.db.TSKetQuaTintuc_GetByTop("", "IDChude=2 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

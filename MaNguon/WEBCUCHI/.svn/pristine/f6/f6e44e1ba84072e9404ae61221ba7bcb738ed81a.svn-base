<%@ Page Title="" Language="C#" MasterPageFile="~/web.PhongDaotao/web.Phongdaotao.Master" AutoEventWireup="true" CodeBehind="DaoTao_GioiThieu.aspx.cs" Inherits="WebSchool.web.PhongDaotao.DaoTao_GioiThieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <article class="art-post art-article">
        <div class="art-postmetadataheader">
            <h4 class="art-postheader">Giới thiệu</h4>

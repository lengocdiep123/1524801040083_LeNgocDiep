<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinSinhvien.aspx.cs" Inherits="WebSchool.web.Admin.listTinSinhvien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTincongtacsinhvien.aspx" class="active">Đăng tin phòng công tác học sinh viên</a>
                              <ul class="active">
                                 <li><a href="listTincongtacsinhvien.aspx">Đăng tin phòng công tác học sinh sinh viên</a>
            ...
            <div class="art-layout-cell art-content"><article class="art-post art-article">
                <asp:Panel ID="pnList" runat="server">
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix"><p><br/></p>
                        ...
                        <p><a><span style="font-weight: bold; font-size: 14px; color: #7D2B03;">Chủ đề:&nbsp;&nbsp;</span><asp:DropDownList ID="ddlChude" runat="server" DataSourceID="SqlTruongGTChude" DataTextField="Chude" DataValueField="ID" OnSelectedIndexChanged="ddlChude_SelectedIndexChanged" AutoPostBack="True" CssClass="art-button" Width="280px"></asp:DropDownList>
                            <asp:SqlDataSource runat="server" ID="SqlTruongGTChude" ConnectionString='<%$ ConnectionStrings:websiteschoolConnectionString %>' SelectCommand="SELECT * FROM [TruongSinhvien]"></asp:SqlDataSource>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <asp:Button ID="bt_previousnews" Text="Hủy" runat="server" CssClass="art-button" OnClick="bt_previousnews_Click" />
                                                    </td>
                                                </tr>
                ...
                <asp:Panel ID="pnbuttonfile" runat="server">
                                     ...
                                     <div class="art-layout-cell" style="width: 100%" >
                                        <table class="art-article" style="width: 100%; ">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2">
                                                         <asp:LinkButton ID="bt_backlist" runat="server" Text="Trở về danh sách" CssClass="art-button" OnClientClick="bt_backlist_Click" OnClick="bt_backlist_Click"></asp:LinkButton>

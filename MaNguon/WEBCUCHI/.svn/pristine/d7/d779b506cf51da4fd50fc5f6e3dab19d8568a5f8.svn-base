...
{
    public partial class ChangeHeaderCTSV : System.Web.UI.Page
    {
        ...
        protected void bt_savefile_Click(object sender, EventArgs e)
        {
            ...
            if (upfile1.HasFile)
            {
                ...
                {
                    strFileName01 = string.Format("{0}\\{1}{2}", Server.MapPath(@"web.PhongCongtacHSSV/images"), "header", upfile1.FileName.Substring(upfile1.FileName.LastIndexOf(".")));

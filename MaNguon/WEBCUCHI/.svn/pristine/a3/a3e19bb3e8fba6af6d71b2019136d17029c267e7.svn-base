<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="PB_Phongcongtachssv.aspx.cs" Inherits="WebSchool.web.Truong.PB_Phongcongtachssv" %>

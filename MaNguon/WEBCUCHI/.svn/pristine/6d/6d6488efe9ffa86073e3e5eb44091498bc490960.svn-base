            ...
            <div class="art-layout-cell art-content"><article class="art-post art-article">
                ...
                <asp:Panel ID="pnCreate" runat="server">
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix"><p><br/></p>
                        ...
                        <p style="padding-left: 40px;"><span style="font-weight: bold; color: #7D2B03;">Mật khẩu:hẩu:</span> &nbsp;<asp:TextBox ID="txtPassword" runat="server" TextMode="Password"></asp:TextBox>

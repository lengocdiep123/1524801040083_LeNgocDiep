...
{
    public partial class PB_Phongdaotao : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongPhongBanServiecs.db.TruongPhongBan_GetByTop("", "ID=4", "");
                ...
                DataTable dt = TruongPhongBanTinServiecs.db.TruongPhongBanTintuc_GetByTop("", "IDChude=4 and dangtin=1", "ID desc");
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                response.AddHeader("Content-Disposition", "attachment;filename=\"" + tach[tach.Length - 1]);

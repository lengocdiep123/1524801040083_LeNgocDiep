<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinnoibotruong.aspx.cs" Inherits="WebSchool.web.Admin.listTinnoibotruong" %>
                    ...
                    <ul class="art-vmenu">
                        <li><a  class="active">Đăng tin giới thiệu và nội bộ trường</a>
                            <ul class="active">
                                ...
                                <li><a href="listTintruongvanoibo.aspx">Đăng tin nội bộ</a></li>
                            </ul>
                        </li>
                    </ul>
                ...
                <asp:Panel ID="pnList" runat="server">
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix"><p><br/></p>
                        ...
                        <p><a><span style="font-weight: bold; font-size: 14px; color: #7D2B03;">Chủ đề:&nbsp;&nbsp;</span><asp:DropDownList ID="ddlChude" runat="server" DataSourceID="SqlTruongGTChude" DataTextField="Chude" DataValueField="ID" OnSelectedIndexChanged="ddlChude_SelectedIndexChanged" AutoPostBack="True" CssClass="art-button" Width="280px"></asp:DropDownList>
                            <asp:SqlDataSource runat="server" ID="SqlTruongGTChude" ConnectionString='<%$ ConnectionStrings:websiteschoolConnectionString %>' SelectCommand="SELECT * FROM [TruongNoiBo]"></asp:SqlDataSource>

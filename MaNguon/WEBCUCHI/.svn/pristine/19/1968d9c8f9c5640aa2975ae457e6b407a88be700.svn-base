<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinquantrithietbi.aspx.cs" Inherits="WebSchool.web.Admin.listTinquantrithietbi" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTintaichinh.aspx" class="active">Đăng tin quản trị thiết bị</a>
                             <ul class="active">

<%@ Page Title="" Language="C#" MasterPageFile="~/web.PhongDaotao/web.Phongdaotao.Master" AutoEventWireup="true" CodeBehind="DaoTao_CTDT_TCN.aspx.cs" Inherits="WebSchool.web.PhongDaotao.DaoTao_CTDT_TCN" %>

...
{
    public partial class DT_Congdoan : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongDoanTheServiecs.db.TruongDoanThe_GetByTop("", "ID=3", "");
                ...
                DataTable dt = TruongDoanTheTinServiecs.db.TruongDoanTheTintuc_GetByTop("", "IDChude=3 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {

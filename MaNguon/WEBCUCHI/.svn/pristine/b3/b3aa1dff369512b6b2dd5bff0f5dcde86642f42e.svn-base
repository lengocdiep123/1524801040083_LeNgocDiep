<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinkhoadiendienlanh.aspx.cs" Inherits="WebSchool.web.Admin.listTinkhoadiendienlanh" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTinkhoadiendienlanh.aspx" class="active">Đăng tin khoa điện điện lạnh</a>
                             <ul class="active">

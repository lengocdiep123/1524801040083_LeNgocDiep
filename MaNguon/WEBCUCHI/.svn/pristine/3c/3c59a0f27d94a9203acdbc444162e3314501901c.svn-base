...
{
    public partial class NB_Lichcongtac : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            headTag = (HtmlHead)this.Header; if (!IsPostBack)
            {
                DataTable dttieude = TruongNoiBoServiecs.db.TruongNoiBo_GetByTop("", "ID=3", "");
                ...
                DataTable dt = TruongNoiBoTinServiecs.db.TruongNoiBoTintuc_GetByTop("", "IDChude=3 and dangtin=1", "ID desc");

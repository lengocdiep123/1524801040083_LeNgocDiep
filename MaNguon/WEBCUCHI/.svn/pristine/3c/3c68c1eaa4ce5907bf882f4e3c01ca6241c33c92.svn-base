...
{
    public partial class Tainguyen_Bieumau : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataTable dttieude = TruongTaiNguyenServiecs.db.TruongTaiNguyen_GetByTop("", "ID=1", "");
                ...
                DataTable dt = TruongTaiNguyenTinServiecs.db.TruongTaiNguyenTintuc_GetByTop("", "IDChude=1 and dangtin=1", "ID desc");
        ...
        protected void lbtnews_Command(object sender, CommandEventArgs e)
        {
            ...
            DataTable dt = TruongTaiNguyenTinServiecs.db.TruongTaiNguyenTintuc_GetByTop("", "ID=" + ID, "");
        ...
        DataTable BindGirdListFile(string IDTin)
        {
            ...
            dt = TruongTaiNguyenFileServices.db.TruongTaiNguyenFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                string ID = e.CommandArgument.ToString();
                DataTable dt = TruongTaiNguyenFileServices.db.TruongTaiNguyenFile_GetByTop("", "ID=" + ID, "");

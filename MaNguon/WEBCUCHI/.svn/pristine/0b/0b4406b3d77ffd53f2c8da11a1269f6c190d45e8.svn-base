<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTinttboiduongkynangvaquanhedoanhnghiep.aspx.cs" Inherits="WebSchool.web.Admin.listTinttboiduongkynangvaquanhedoanhnghiep" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTinttboiduongkynangvaquanhedoanhnghiep.aspx" class="active">Đăng tin trung tâm bồi dưỡng kĩ năng nghề và quan hệ doanh nghiệp</a>
                             <ul class="active">
                ...
                <asp:Panel ID="pnList" runat="server">
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix"><p><br/></p>
                        ...
                        <p><a><span style="font-weight: bold; font-size: 14px; color: #7D2B03;">Chủ đề:&nbsp;&nbsp;</span><asp:DropDownList ID="ddlChude" runat="server" DataSourceID="SqlTruongGTChude" DataTextField="Chude" DataValueField="ID" OnSelectedIndexChanged="ddlChude_SelectedIndexChanged" AutoPostBack="True" CssClass="art-button" Width="280px" Enabled="False"></asp:DropDownList>
                            <asp:SqlDataSource runat="server" ID="SqlTruongGTChude" ConnectionString='<%$ ConnectionStrings:websiteschoolConnectionString %>' SelectCommand="SELECT * FROM [TruongKhoaTrungTam] WHERE ([ID] = @ID)">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="11" Name="ID" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>

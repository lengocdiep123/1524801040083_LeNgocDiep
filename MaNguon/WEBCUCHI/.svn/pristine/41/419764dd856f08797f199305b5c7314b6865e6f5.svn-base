<%@ Page Title="" Language="C#" MasterPageFile="~/web.Truong/webTruong.Master" AutoEventWireup="true" CodeBehind="PB_Phonghanhchinh.aspx.cs" Inherits="WebSchool.web.Truong.PB_Phonghanhchinh" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="art-postmetadataheader">
            <h2 class="art-postheader">PHÒNG HÀNH CHÍNH - TỔ CHỨC</h2>

...
{
    public partial class PB_Phongdambaochatluong : System.Web.UI.Page
    {
        HtmlHead headTag;
        int numberpage = 12;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
				DataTable dttieude = TruongPhongBanServiecs.db.TruongPhongBan_GetByTop("", "ID=7", "");
                ...
                DataTable dt = TruongPhongBanTinServiecs.db.TruongPhongBanTintuc_GetByTop("", "IDChude=7 and dangtin=1", "ID desc");
                if (dt.Rows.Count > 0)
                {
        ...
        protected void lbtback_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = TruongPhongBanTinServiecs.db.TruongPhongBanTintuc_GetByTop("", "IDChude=5 and dangtin=1", "ID desc");
        ...
        DataTable BindGirdListFile(string IDTin)
        {
            ...
            dt = TruongPhongBanFileServices.db.TruongPhongBanFile_GetByTop("", "IDTin=" + IDTin, "");
            return dt;
        }
        ...
        protected void lbtlinkdownload_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                string ID = e.CommandArgument.ToString();
                DataTable dt = TruongPhongBanFileServices.db.TruongPhongBanFile_GetByTop("", "ID=" + ID, "");

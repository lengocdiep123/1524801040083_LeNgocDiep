<%@ Page Title="" Language="C#" MasterPageFile="~/web.Admin/webAdmin.Master" AutoEventWireup="true" CodeBehind="listTincongdoan.aspx.cs" Inherits="WebSchool.web.Admin.listTincongdoan" %>
            ...
            <div class="art-content-layout-row">
             <div class="art-layout-cell art-sidebar1"><div class="art-vmenublock clearfix">
                <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                        <li><a href="listTincongdoan.aspx" class="active">Đăng tin công đoàn</a>
                             <ul class="active">
